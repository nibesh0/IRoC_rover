...
bool yolo_msgs__msg__yolo_detection__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("yolo_msgs.msg._yolo_detection.YoloDetection", full_classname_dest, 43) == 0);
  }
  yolo_msgs__msg__YoloDetection * ros_message = _ros_message;
  {  // x1
...
PyObject * yolo_msgs__msg__yolo_detection__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("yolo_msgs.msg._yolo_detection");
